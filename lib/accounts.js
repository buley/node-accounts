...
Public.prototype.secrets = function( path ) {
    ...
    // Evernote (oauth 1.0)
    var authBuff = new Buffer("" + evernote.id + ":" + evernote.secret);
    service.evernote = new OAuth( "https://www.evernote.com/oauth", "https://www.evernote.com/oauth", evernote.id, evernote.secret, "1.0", evernote.callback || '', "HMAC-SHA1", null, {
        'Authorization': "Basic " + authBuff.toString('base64')
    }  );
    service.evernote.useAuthorizationHeaderforGET( true );
};
