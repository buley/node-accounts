...
Private.handle_tumblr = function( params, callback ) {
	...
	if( params && 'logout' == params.command ) {
	...
	} else if( params && 'sign' == params.command ) {
		...
		var oauth_token = params.oauth_token
			, oauth_token_securet = params.oauth_token_secret || null
			, method = params.method || 'GET'
			, url = params.url || ''
			, extra_params = params.params || {}
			, headers = service.tumblr._prepareParameters( oauth_token, oauth_token_secret, method, url, extra_params );
...
Private.handle_twitter = function( params, callback ) {
	...
	if( params && 'logout' == params.command ) {
		...
		var oauth_token = params.oauth_token
			...
			, url = params.url || ''
			, extra_params = params.params || {}
			, headers = service.twitter._prepareParameters( oauth_token, oauth_token_secret, method, url, extra_params );
