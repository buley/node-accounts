        ...
        if( params.error == 'access_denied' ) {
            ...
            service.youtube.getOAuthAccessToken( params.code, {
                ...
                if( error ) {
                    ...
                    service.youtube.get( "https://www.googleapis.com/youtube/v3/channels?part=id,snippet,auditDetails,contentDetails,invideoPromotion,statistics,status,topicDetails&mine=true", access_token, function(error, data){
