...
Public.prototype.secrets = function( path ) {
    ...
    // Evernote (oauth 1.0)
    service.evernote = new OAuth( "https://sandbox.evernote.com/oauth", "https://sandbox.evernote.com/oauth", evernote.id, evernote.secret, "1.0a", evernote.callback || '', "HMAC-SHA1" );
};
