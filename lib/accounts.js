...
Private.handle_reddit = function( params, callback ) {
    ...
    if( params && 'logout' == params.command ) {
        ...
        service.reddit.get( "https://ssl.reddit.com/api/v1/authorize", params.access_token, params.access_token_secret, function (error, data, result ) {
            if( error ) {
        ...
        service.reddit.getOAuthAccessToken( params.oauth_token, params.oauth_token_secret, params.oauth_verifier, function( error, oauth_access_token, oauth_access_token_secret, additionalParameters ) {
            ...
            if( error ) {
                ...
                service.reddit.get( "http://api.reddit.com/v2/user/info", oauth_access_token, oauth_access_token_secret, function (error, data, result ) {
        ...
        service.reddit.getOAuthRequestToken( function( error, oauth_request_token, oauth_request_token_secret, oauth_authorize_url, additionalParameters ) {
            console.log("REDDIT REQ TOKEN",error);
            if(error) {
                ...
                var authentication_url = "https://ssl.reddit.com/api/v1/authorize?oauth_token=" + oauth_request_token;
        ...
        service.vimeo.getOAuthAccessToken( params.oauth_token, params.oauth_token_secret, params.oauth_verifier, function( error, oauth_access_token, oauth_access_token_secret, additionalParameters ) {
            ...
            if( error ) {
                ...
                service.vimeo.get( "http://vimeo.com/api/rest/v2?format=json&method=vimeo.people.getInfo&user_id=" + oauth_access_token, oauth_access_token, oauth_access_token_secret, function (error, data, result ) {
                    ...
                    var parsed = JSON.parse( data );
                    console.log('VIMEO PROFILE',parsed);
...
Private.handle_instagram = function( params, callback ) {
    ...
    if( params && 'connect' == params.command ) {
        ...
        if( params.error_reason == 'user_denied' ) {
            ...
            console.log('GET INSTA',params.code);
            service.instagram.getOAuthAccessToken( params.code, {
                ...
                console.log('got insta', data );
                if( error ) {
                    console.log('insta err 1');
...
Private.handle_youtube = function( params, callback ) {
    ...
    if( params && 'connect' == params.command ) {
        ...
        service.youtube.get( "https://www.googleapis.com/plus/v1/people/me", params.access_token, function( error, data ) {
        ...
        if( params.error == 'access_denied' ) {
            ...
            service.youtube.getOAuthAccessToken( params.code, {
                ...
                if( error ) {
                    ...
                    service.youtube.get( "https://www.googleapis.com/plus/v1/people/me", access_token, function(error, data){
                        if( error ) {
...
Public.prototype.secrets = function( path ) {
    ...
    // YouTube (oAuth 2)
    service.youtube = new OAuth2( youtube.id, youtube.secret,  "", "https://accounts.google.com/o/oauth2/auth", "https://accounts.youtube.com/o/oauth2/token" );
    service.youtube.setAccessTokenName( youtube.token || "oauth_token" );

    // Blogger (oAuth 2)
    service.blogger = new OAuth2( blogger.id, blogger.secret,  "", "https://accounts.google.com/o/oauth2/auth", "https://accounts.blogger.com/o/oauth2/token" );
    ...
    // Reddit (oauth 1.0)
    service.reddit = new OAuth( "https://ssl.reddit.com/api/v1/access_token", "https://ssl.reddit.com/api/v1/access_token", reddit.id, reddit.secret, "1.0", reddit.callback || '', "HMAC-SHA1" );

    // Evernote (oauth 1.0)
    service.evernote = new OAuth( "https://sandbox.evernote.com/oauth", "https://sandbox.evernote.com/OAuth.action", evernote.id, evernote.secret, "1.0", evernote.callback || '', "HMAC-SHA1" );
