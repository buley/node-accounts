...
Private.handle_tumblr = function( params, socket, type ) {
	...
	if( params && 'logout' == params.command ) {
		...
		console.log("DAY TO DAY THINGS: " + JSON.stringify( params ) );
		service.tumblr.getOAuthAccessToken( params.oauth_token, params.oauth_token_secrets, params.oauth_verifier, function( error, oauth_access_token, oauth_access_token_secret, additionalParameters ) {
