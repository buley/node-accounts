    ...
    if( params && 'logout' === params.action ) {
        ...
        service.vimeo.getOAuthAccessToken( params.code, {
            ...
            if( error ) {
                ...
                service.vimeo.get( "https://api.vimeo.comformat=json&method=vimeo.people.getInfo&user_id=" + access_token, access_token, oauth_token_secret, function (error, data, result ) {
