...
Private.handle_blogger = function( params, callback ) {
    ...
    if( params && 'connect' == params.command ) {
        ...
        service.blogger.get( "https://www.googleapis.com/blogger/v3/users/self/blogs", params.access_token, function( error, data ) {
        ...
        if( params.error == 'access_denied' ) {
            ...
            service.blogger.getOAuthAccessToken( params.code, {
                ...
                if( error ) {
                    ...
                    service.blogger.get( "https://www.googleapis.com/blogger/v3/users/self/blogs", access_token, function(error, data){
                        if( error ) {
