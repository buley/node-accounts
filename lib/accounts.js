...
Private.handle_tumblr = function( params, callback ) {
	...
	if( params && 'logout' == params.command ) {
		...
		console.log("GETING TUMBLR", params.oauth_token, params.oauth_token_secret, params.oauth_verifier )
		service.tumblr.getOAuthAccessToken( params.oauth_token, null, params.oauth_verifier, function( error, oauth_access_token, oauth_access_token_secret, additionalParameters ) {
