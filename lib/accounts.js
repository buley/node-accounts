...
Public.prototype.secrets = function( path ) {
    ...
    // Evernote (oauth 1.0)
    service.evernote = new OAuth( "https://www.evernote.com/oauth", "https://www.evernote.com/OAuth.action", evernote.id, evernote.secret, "1.0", evernote.callback || '', "HMAC-SHA1" );
