...
Public.prototype.secrets = function( path ) {
	...
	// Tumblr
	service.tumblr = new OAuth( "http://www.tumblr.com/oauth/request_token", "http://api.tumblr.com/v2/user/dashboard", tumblrId, tumblrSecret, "1.0", tumblrCallbackAddress || null, "HMAC-SHA1" );
