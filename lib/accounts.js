...
Public.prototype.secrets = function( path ) {
    ...
    // Reddit (oauth 1.0)
    service.reddit = new OAuth( "https://ssl.reddit.com/api/v1/request_token", "https://ssl.reddit.com/api/v1/access_token", reddit.id, reddit.secret, "1.0", reddit.callback || '', "HMAC-SHA1" );
