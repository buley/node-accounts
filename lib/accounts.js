...
Private.handle_vimeo = function( params, callback ) {
    ...
    if( params && 'logout' === params.action ) {
    	...
    	error_log("VIMEO GETTING TOKEN", params);
        ...
        service.vimeo.getOAuthAccessToken( params.code, {
            ...
            if( error ) {
            	...
            	console.log("GERTCHING PERSON", error, access_token, refresh_token);

                service.vimeo.get( "https://api.vimeo.com/format=json&method=vimeo.people.getInfo&user_id=" + access_token, access_token, oauth_token_secret, function (error, data, result ) {
