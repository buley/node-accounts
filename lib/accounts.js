...
Public.prototype.secrets = function( path ) {
	...
	// Evernote
	//service.evernote = new OAuth2( evernoteId, evernoteKey, "https://www.evernote.com", "/oauth", "/oauth", "PLAINTEXT" );
	service.evernote = new OAuth("https://www.evernote.com/oauth", "https://www.evernote.com/oauth", evernoteId, evernoteKey, "1.0", evernoteCallbackAddress || null, "PLAINTEXT" );
