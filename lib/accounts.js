...
Private.handle_tumblr = function( params, socket, type ) {
	...
	if( params && 'logout' == params.command ) {
		...
		service.tumblr.getOAuthAccessToken( params.oauth_token, params.oauth_verifier, function( error, oauth_access_token, oauth_access_token_secret, additionalParameters ) {
			...
			console.log("OAUTH TUMBLR1",params.oauth_token, params.oauth_verifier,error,oauth_access_token,oauth_access_token_secret,additionalParameters);
				//TODO: Destroy tokens
			...
			console.log("OAUTH TUMBLR2",params.oauth_token, params.oauth_verifier,error,oauth_access_token,oauth_access_token_secret,additionalParameters);
