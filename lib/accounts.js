        ...
        if( params.error_reason == 'user_denied' ) {
            ...
            service.soundcloud.getOAuthAccessToken( params.code, {
                ...
                if( error ) {
                    ...
                    service.soundcloud.get( "https://api.soundcloud.com/me?oauth_token=" + access_token, access_token, function ( error, data, response ) {
...
Public.prototype.secrets = function( path ) {
    ...
    service.soundcloud = new OAuth2( wordpress.id, wordpress.secret, "https://soundcloud.com", "/connect", "https://api.soundcloud.com/oauth2/token" );
    service.soundcloud.setAccessTokenName( wordpress.token || "oauth_token");
