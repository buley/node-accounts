...
Public.prototype.secrets = function( path ) {
    ...
    // Evernote (oauth 1.0)
    service.evernote = new OAuth( "http://vimeo.com/oauth/request_token", "http://vimeo.com/oauth/access_token", evernote.id, evernote.secret, "1.0", evernote.callback || '', "HMAC-SHA1" );
