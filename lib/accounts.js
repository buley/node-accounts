                ...
                if( null !== error ) {
                    ...
                    service.reddit.get( "https://oauth.reddit.com/api/v1/me", access_token, function ( error, data, response ) {
                        if( error ) {
                            ...
                            service.reddit.get( "https://oauth.reddit.com/reddits/mine/subscriber.json", access_token, function ( error2, data2, response2 ) {

								profile.subscriptions = data2.data.children;
